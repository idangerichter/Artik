...
__attribute__((always_inline)) inline int32_t ProbeTiming(void* p)
{
...
__attribute__((always_inline)) inline void MemoryAccess(void* p)
{
  int tmp = 0;
...
__attribute__((always_inline)) inline void MemoryFlush(void* p)
{
